...
API_ID = int(environ.get('API_ID', '11657778'))
API_HASH = environ.get('API_HASH', '56b209fe074993cf4d123fdfb74ab545')
BOT_TOKEN = environ.get('BOT_TOKEN', '6630455602:AAHhOIhsFnyCHhPxnOGLVUltIUHuHhOqeRU')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5383602320').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001903522896').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', "-1001840670322")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001911108340'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Shizuka_FilterBot')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001950014818')).split()]
