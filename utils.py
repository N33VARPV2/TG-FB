        ...
        try:
            await bot.send_cached_media(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                        InlineKeyboardButton('🔥 𝕾𝖚𝖕𝖕𝖔𝖗𝖙 𝕲𝖗𝖔𝖚𝖕 🔥', url=GRP_LNK),
                        InlineKeyboardButton('🔔 𝖀𝖕𝖉𝖆𝖙𝖊𝖘 𝕮𝖍𝖆𝖓𝖓𝖊𝖑 🔔', url=CHNL_LNK)
                    ],[
                        InlineKeyboardButton("💗 𝕭𝖔𝖙 𝕺𝖜𝖓𝖊𝖗 💗", url="https://telegram.me/TechnicalBichu")
                        ]
                    ]
                ),
            )
